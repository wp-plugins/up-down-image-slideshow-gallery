...
function udisg() 
{
	...
	?>
    <script type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-content/plugins/up-down-image-slideshow-gallery/inc/jquery.min.js"></script>
    <script type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-content/plugins/up-down-image-slideshow-gallery/inc/up-down-image-slideshow-gallery.js"></script>
