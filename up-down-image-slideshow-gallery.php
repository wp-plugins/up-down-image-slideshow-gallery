...
function udisg() 
{
	...
	{
		_e('Please check the widget setting gallery group', 'udisg');
	}
}
...
{
	echo '<p><b>';
	 _e('Up down slideshow', 'udisg');
	echo '.</b> ';
	_e('Check official website for more information', 'udisg');
	?> <a target="_blank" href="<?php echo WP_UDISG_FAV; ?>"><?php _e('click here', 'udisg'); ?></a></p><?php
}
...
function udisg_init()
{
	...
	{
		wp_register_sidebar_widget('up-down-image-slideshow-gallery', __('Up down image slideshow gallery', 'udisg'), 'udisg_widget');
	}
	
	if(function_exists('wp_register_widget_control')) 
	{
		wp_register_widget_control('up-down-image-slideshow-gallery', array(__('Up down image slideshow gallery', 'udisg'), 'widgets'), 'udisg_control');
	} 
}
...
{
	  load_plugin_textdomain( 'udisg', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
